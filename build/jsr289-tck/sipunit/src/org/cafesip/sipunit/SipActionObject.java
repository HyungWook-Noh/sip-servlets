...
/**
 * A SipActionObject represents any SipUnit object that performs SIP operations
...
public interface SipActionObject
{
     ...
     * performed. If an exception was involved, this string will contain the
     * name of the Exception class and the exception message.
     * 
     * @return A descriptive string describing the cause of the problem
     *         encountered during the last operation performed, or an empty
     *         string if no problem was encountered.
     */
    public String getErrorMessage();

    /**
     * This method is used to get the Exception object generated during the last
     * operation performed. It applies whenever the getReturnCode() method
     * returns internal SipUnit return code EXCEPTION_ENCOUNTERED.
     * 
     * @return The Throwable object generated during the last operation
     *         performed, or null if an Exception didn't occur.
     */
     ...
     * operation performed.
     * 
     * @return A string fully describing the error information associated with
     *         the last operation performed, or a successful indication if no
     *         error occurred.
     */

 ...
 *
 * This class was copied from the Sip Communicator project 
 * (package net.java.sip.communicator.sip.security, its author is 
 * Emil Ivov) and slightly modified here (to remove console/log
 * messages). Thanks for making it publicly available. 
 * It is licensed under the Apache Software License, 
...
public class MessageDigestAlgorithm
{
     ...
     * 
     */
    public static String calculateResponse(String algorithm,
            String username_value, String realm_value, String passwd,
            String nonce_value, String nc_value, String cnonce_value,
            String Method, String digest_uri_value, String entity_body,
            String qop_value)
    {

 ...
 * presentity (buddy, watchee). These elements are optional in a NOTIFY message.
 * A NOTIFY message will contain the complete information known about the
 * presence of the presentity and include all active devices for that presentity

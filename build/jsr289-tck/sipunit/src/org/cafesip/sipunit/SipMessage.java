...
/**
 * SipMessage represents a SipRequest or a SipResponse. SipMessage provides a
 * uniform way of getting information about a SIP message (request or reponse),
...
public class SipMessage
{
    ...
    /**
     * This method is FOR SIPUNIT INTERNAL USE ONLY. It requires knowledge of
     * JAIN SIP API. Used by SipTestCase.
     * 
     * Obtains a ListIterator over all the headers with the specified name in
     * this message. The order of the items returned is the same as the order in
    ...
    /**
     * Obtains the underlying javax.sip.message.Message object. Knowledge of
     * JAIN-SIP API is required.
     * 
    ...
    /**
     * Gets the length of the message body. The returned length does not include
     * the CRLF separating header fields and body. If no body is present, then
     * zero is returned.
     * 
     ...
     * 
     * @return the body content of the message as a byte array or null if a body
     *         isn't present.
     */
    ...
    /**
     * Gets the duration after which the message (or content) expires, relative
     * to message receipt. The value of this field is an integral number of
     * seconds (in decimal) between 0 and (2**32)-1
     * 
     * @return the number of seconds that the message (or content) is valid,

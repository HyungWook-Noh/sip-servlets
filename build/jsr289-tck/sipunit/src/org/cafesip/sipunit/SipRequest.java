...
public class SipRequest extends SipMessage
{
    ...
    private SipTransaction sipTransaction;
    ...
    /**
     * Returns the request URI line of the request message or an empty string if
     * there isn't one. The request URI indicates the user or service to which
    ...
    /**
     * Indicates if the request URI in the request message is a URI with a
     * scheme of "sip" or "sips".
     * 
     * @return true if the request URI scheme is "sip" or "sips", false
     *         otherwise.
     */

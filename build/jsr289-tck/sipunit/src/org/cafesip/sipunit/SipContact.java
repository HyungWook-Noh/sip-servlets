...
public class SipContact
{
     ...
     * 
     * @return Returns the expiry in seconds. If the returned value is 0, the
     *         contact doesn't expire. If the returned value is greater than 0,
     *         it is the original value of the expiry at the time the contact
     *         URI became known - elapsed time since then has NOT been accounted
     *         for.
     */
    ...
    /**
     * The method getURIScheme() returns the scheme of this contact URI ("sip",
     * "sips", etc.).
     * 
     * @return Returns the value of the "scheme" of the contact URI - "sip",
     *         "sips", or "tel".
     */
    ...
    /**
     * This method indicates if this contact URI has a scheme of "sip" or
     * "sips", or not.
     * 

...
public class SipResponse extends SipMessage
{
    ...
    static
    {
        ...
        statusCodeDescription.put(new Integer(MOVED_PERMANENTLY),
                "Moved Permanently");
        statusCodeDescription.put(new Integer(MOVED_TEMPORARILY),
                "Moved Temporarily");
        ...
        statusCodeDescription.put(new Integer(METHOD_NOT_ALLOWED),
                "Method Not Allowed");
        statusCodeDescription
                .put(new Integer(NOT_ACCEPTABLE), "Not Acceptable");
        statusCodeDescription.put(new Integer(PROXY_AUTHENTICATION_REQUIRED),
                "Proxy Authentication Required");
        statusCodeDescription.put(new Integer(REQUEST_TIMEOUT),
                "Request Timeout");
        statusCodeDescription.put(new Integer(GONE), "Gone");
        statusCodeDescription.put(new Integer(REQUEST_ENTITY_TOO_LARGE),
                "Request Entity Too Large");
        statusCodeDescription.put(new Integer(REQUEST_URI_TOO_LONG),
                "Request URI Too Long");
        statusCodeDescription.put(new Integer(UNSUPPORTED_MEDIA_TYPE),
        ...
        statusCodeDescription.put(new Integer(EXTENSION_REQUIRED),
                "Extension Required");
        statusCodeDescription.put(new Integer(INTERVAL_TOO_BRIEF),
                "Interval Too Brief");
        statusCodeDescription.put(new Integer(TEMPORARILY_UNAVAILABLE),
                "Temporarily Unavailable");
        statusCodeDescription.put(new Integer(
        ...
        statusCodeDescription.put(new Integer(ADDRESS_INCOMPLETE),
                "Address Incomplete");
        statusCodeDescription.put(new Integer(AMBIGUOUS), "Ambiguous");
        statusCodeDescription.put(new Integer(BUSY_HERE), "Busy Here");
        statusCodeDescription.put(new Integer(REQUEST_TERMINATED),
                "Request Terminated");
        statusCodeDescription.put(new Integer(NOT_ACCEPTABLE_HERE),
                "Not Acceptable Here");
        statusCodeDescription.put(new Integer(BAD_EVENT), "Bad Event");
        statusCodeDescription.put(new Integer(REQUEST_PENDING),
                "Request Pending");
        statusCodeDescription
        ...
        statusCodeDescription.put(new Integer(SERVICE_UNAVAILABLE),
                "Service Unavailable");
        statusCodeDescription
                .put(new Integer(SERVER_TIMEOUT), "Server Timeout");
        statusCodeDescription.put(new Integer(VERSION_NOT_SUPPORTED),
        ...
        statusCodeDescription.put(new Integer(DOES_NOT_EXIST_ANYWHERE),
                "Does Not Exist Anywhere");
        statusCodeDescription.put(new Integer(SESSION_NOT_ACCEPTABLE),
     ...
     *            returned by SipSession.waitResponse()
     */
     ...
     * 
     * @return the reason phrase associated with the status code of this
     *         response message
     */

...
public class SipCall implements SipActionObject, MessageListener
{
    ...
    /**
     * Start listening for an PRACK request. This is a non-blocking call. Starting
     * from the time this method is called, any received request(s) for this UA
     * are collected. After calling this method, you can call waitForPrack() to
     * process the first PRACK received since calling this method.
     * 
     * NOTE: it's not necessary to call this method if a previous listenForXyz()
     * method has been called and request listening has NOT been turned off
     * since (ie, method stopListeningForRequests() hasn't been called).
     ...
     *         returned.
     */
    public boolean listenForPrack()
    {
        return parent.listenRequestMessage();
    }

    /**
     * Start listening for a request. This is a non-blocking call. Starting
     * from the time this method is called, any received request(s) for this UA
     * are collected. After calling this method, you can call waitForRequest() to
     * process the first Request received since calling this method.
     * 
     * NOTE: it's not necessary to call this method if a previous listenForXyz()
     * method has been called and request listening has NOT been turned off
     * since (ie, method stopListeningForRequests() hasn't been called).
    ...
    /**
     * Start listening for an UPDATE request. This is a non-blocking call. Starting
     * from the time this method is called, any received request(s) for this UA
     * are collected. After calling this method, you can call waitForUpdate() to
     * process the first UPDATE received since calling this method.
     * 
     * NOTE: it's not necessary to call this method if a previous listenForXyz()
     * method has been called and request listening has NOT been turned off
     * since (ie, method stopListeningForRequests() hasn't been called).
     ...
     *         returned.
     */
    public boolean listenForUpdate()
    {
        return parent.listenRequestMessage();
    }
    ...
    /**
     * The waitForPrack() method waits for an PRACK request addressed to this user
     ...
     * request listening. 
     * <p>
     * This method blocks until one of the following occurs: 1) An PRACK request
     * message has been received, addressed to this user agent. In this case, a
     * value of true is returned. The getLastReceivedRequest() method can be
     * called to get information about the received PRACK request. 2) The wait
     ...
     * case.
     * <p>
     * Any non-PRACK requests received for this user agent are discarded while
     * waiting for an PRACK message.
     * <p>
     * Regardless of the outcome, incoming requests associated with this User
     * Agent will continue to be queued up until the stopListeningForRequests()
     * method is called. IT IS RECOMMENDED THAT THE CALLING PROGRAM STOP
     ...
     * @return false in the case of wait timeout or error; call getReturnCode()
     *         and/or getErrorMessage() and, if applicable, getException() for
     *         further diagnostics. A true value is returned if an PRACK message
     *         was received. Call the getLastReceivedRequest() method to get
     *         information about the PRACK.
     */
    public boolean waitForPrack(long timeout)
    {
    	return waitForSpecialRequest(Request.PRACK, timeout);
    }

    /**
     * The waitForUpdate() method waits for an UPDATE request addressed to this user
     * agent to be received from the network. Prior to calling this method, any
     * of the listenForXyz() methods must have already been called to turn on
     * request listening. 
     * <p>
     * This method blocks until one of the following occurs: 1) An UPDATE request
     * message has been received, addressed to this user agent. In this case, a
     * value of true is returned. The getLastReceivedRequest() method can be
     * called to get information about the received UPDATE request. 2) The wait
     * timeout period specified by the parameter to this method expires. false
     * is returned in this case. 3) An error occurs. false is returned in this
     * case.
     * <p>
     * Any non-UPDATE requests received for this user agent are discarded while
     ...
     * @return false in the case of wait timeout or error; call getReturnCode()
     *         and/or getErrorMessage() and, if applicable, getException() for
     *         further diagnostics. A true value is returned if an UPDATE message
     *         was received. Call the getLastReceivedRequest() method to get
     *         information about the UPDATE.
     */
    public boolean waitForUpdate(long timeout)
    {
    	return waitForSpecialRequest(Request.UPDATE, timeout);
    }
    
    /**
     * The waitForRequest() method waits for a specific request addressed to this user
     * agent to be received from the network. Prior to calling this method, any
     * of the listenForXyz() methods must have already been called to turn on
     * request listening. 
     * <p>
     * This method blocks until one of the following occurs: 1) A specific request
     * message has been received, addressed to this user agent. In this case, a
     * value of true is returned. The getLastReceivedRequest() method can be
     * called to get information about the received request. 2) The wait
     * timeout period specified by the parameter to this method expires. false
     * is returned in this case. 3) An error occurs. false is returned in this
     * case.
     * <p>
     * Any other requests received for this user agent are discarded while
     ...
     * 
     * @param method
     *            The specific method waited for.
     * @param timeout
     *            The maximum amount of time to wait, in milliseconds. Use a
     *            value of 0 to wait indefinitely.
     * @return false in the case of wait timeout or error; call getReturnCode()
     *         and/or getErrorMessage() and, if applicable, getException() for
     *         further diagnostics. A true value is returned if a specific message
     *         was received. Call the getLastReceivedRequest() method to get
     *         information about the request.
     */
    public boolean waitForRequest(String method, long timeout)
    {
    	return waitForSpecialRequest(method, timeout);
    }
    
    /**
     * The waitForCancel() method waits for an CANCEL request addressed to this user
     * agent to be received from the network. Prior to calling this method, any
     * of the listenForXyz() methods must have already been called to turn on
     * request listening. 
     * <p>
     * This method blocks until one of the following occurs: 1) An CANCEL request
     * message has been received, addressed to this user agent. In this case, a
     * value of true is returned. The getLastReceivedRequest() method can be
     * called to get information about the received CANCEL request. 2) The wait
     * timeout period specified by the parameter to this method expires. false
     * is returned in this case. 3) An error occurs. false is returned in this
     * case.
     * <p>
     * Any non-CANCEL requests received for this user agent are discarded while
     * waiting for an CANCEL message.
     * <p>
     * Regardless of the outcome, incoming requests associated with this User
     * Agent will continue to be queued up until the stopListeningForRequests()
     * method is called. IT IS RECOMMENDED THAT THE CALLING PROGRAM STOP
     ...
     * @return false in the case of wait timeout or error; call getReturnCode()
     *         and/or getErrorMessage() and, if applicable, getException() for
     *         further diagnostics. A true value is returned if an CANCEL message
     *         was received. Call the getLastReceivedRequest() method to get
     *         information about the CANCEL.
     */
    public boolean waitForCancel(long timeout)
    {
    	return waitForSpecialRequest(Request.CANCEL, timeout);
    }
    
    private boolean waitForSpecialRequest(String method, long timeout)
    {
        initErrorInfo();
        ...
        receivedRequests.add(sipRequest);

        while (request.getMethod().equals(method) == false)
        {
            event = parent.waitRequest(timeout); // TODO, adjust
        ...
        sipTransaction.setServerTransaction(tr);
        sipRequest.setSipTransaction(sipTransaction);
        return true;
    }
    ...
    /**
     * This method sends a reliable response to a previously received INVITE
     ...
     */
    public boolean sendIncomingCallReliableResponse(int statusCode,
            String reasonPhrase, int expires)
    {
		return sendIncomingCallReliableResponse(statusCode, reasonPhrase, expires,
                null, null, null);
    }

    /**
     * This method is the same as the basic sendIncomingCallReliableResponse() method
            ...
            ArrayList replaceHeaders, String body)
    {
    	...
    	if (statusCode <= 100 || statusCode > 199) {
            ...
            errorMessage = (String) SipSession.statusCodeDescription
                    ...
                    + " - statusCode is illegal";
            return false;
    	}

        if (!Request.INVITE.endsWith(transaction.getServerTransaction().getRequest().getMethod())) {
    		returnCode = SipSession.INVALID_OPERATION;
            errorMessage = (String) SipSession.statusCodeDescription
                    .get(new Integer(returnCode))
                    + " - request should be an INVITE";
            return false;
    	}
        ...
        if (parent.sendReliableReply(transaction, statusCode, reasonPhrase, myTag,
    ...
    /**
     * This method sends a basic response to a special request. The response 
     * is constructed based on the parameters passed in. 
     * 
     * @param request
     *            The request which need to response.
     * @param statusCode
     *            The status code of the response to send (may use SipResponse
     *            constants).
     * @param reasonPhrase
     ...
     * @return true if the response was successfully sent, false otherwise.
     */
    public boolean sendResponseToLastReceivedRequest(int statusCode,
            String reasonPhrase, int expires)
    {
        return sendResponseToLastReceivedRequest(statusCode, reasonPhrase, expires,
                null, null, null);
    }

    /**
     * This method is the same as the basic sendResponse() method
     * except that it allows the caller to specify a message body and/or
     * additional JAIN-SIP API message headers to add to or replace in the
     * outbound message. Use of this method requires knowledge of the JAIN-SIP
     * API.
    ...
    public boolean sendResponseToLastReceivedRequest(int statusCode,
            ...
            ArrayList replaceHeaders, String body)
    {
    	return sendResponse(getLastReceivedRequest().getSipTransaction(), statusCode,
                reasonPhrase, expires, additionalHeaders,
                replaceHeaders, body);
    }
    private boolean sendResponse(SipTransaction transaction, int statusCode,
            String reasonPhrase, int expires, ArrayList additionalHeaders,
            ArrayList replaceHeaders, String body)
    {
        initErrorInfo();
        ...
        if (parent.sendReply(transaction, statusCode, reasonPhrase, myTag,
                ...
                replaceHeaders, body) != null)
        {
            if (transaction.getServerTransaction().getDialog() != null)
            {
            	dialog = transaction.getServerTransaction().getDialog();
            }
     ...
     * 
     */
    public boolean sendResponse(int statusCode,
            String reasonPhrase, int expires, String body, String contentType,
            String contentSubType, ArrayList additionalHeaders,
            ArrayList replaceHeaders)
    {
    ...
    public boolean sendIncomingCallResponse(int statusCode,
            ...
            ArrayList replaceHeaders, String body)
    {
    	return sendResponse(transaction, statusCode,
                reasonPhrase, expires, additionalHeaders,
                replaceHeaders, body);
    }
    ...
    /**
     * This method sends a basic PRACK in response to an received 100Rel response.
     * 
     * @return true if the message was successfully sent, false otherwise.
     */
    public boolean sendPrack()
    {
        return sendPrack(null, null, null);
    }

    /**
     * This method is the same as the basic sendPrack() method except that
     ...
     *            body bytes.
     */
    public boolean sendPrack(ArrayList additionalHeaders,
            ArrayList replaceHeaders, String body)
    {
        initErrorInfo();
        ...
        try
        {
    		...
    		Response reliableResponse = (Response)getLastReceivedResponse().getMessage();
    	    ...
    	    if (reliableResponse.getStatusCode() <= 100 
    	    		|| reliableResponse.getStatusCode() >= 200) {
                returnCode = SipSession.INVALID_OPERATION;
                errorMessage = (String) SipSession.statusCodeDescription
                        .get(new Integer(returnCode))
                        + " - response is not a 1xx response";
    			return false;
    		}
    	    
    	    if (!Request.INVITE.equals(((CSeqHeader) reliableResponse
    	    		  .getHeader(CSeqHeader.NAME)).getMethod())) {
                returnCode = SipSession.INVALID_OPERATION;
                errorMessage = (String) SipSession.statusCodeDescription
                        .get(new Integer(returnCode))
                        + " - response is not for INVITE";
      			return false;
      		}
    	    
    	    Request initReq = transaction.getRequest();
    	    if (!isSupportedOptionTagExist(initReq, "100Rel")
    	              && !isRequireOptionTagExist(initReq, "100Rel")) {
                  returnCode = SipSession.INVALID_OPERATION;
                  errorMessage = (String) SipSession.statusCodeDescription
                          .get(new Integer(returnCode))
                          + " - the init request doesn't require or support 100 reliable";
                  return false;
            }
    	    
    	    if (!isRequireOptionTagExist(reliableResponse, "100Rel") 
    	    		  || ((RSeqHeader) reliableResponse.getHeader
    	    				  (RSeqHeader.NAME)).getSeqNumber() < 1) {
                returnCode = SipSession.INVALID_OPERATION;
                errorMessage = (String) SipSession.statusCodeDescription
                        .get(new Integer(returnCode))
      		...
      		Request prack = dialog.createPrack(reliableResponse);
    		
            parent.addAuthorizations(callId.getCallId(), prack);
            synchronized (this) // needed for asynchronous response -
            {
                parent.sendRequestWithTransaction(prack, false,
    ...
    /**
     * judge if the message require the optionTag
     * @param message 
     * @param optionTag 
     * @return boolean: true :the message require the optionTag false:not require
     */
    private static boolean isRequireOptionTagExist(Message message,
    		String optionTag) {
    	ListIterator requireIterator = message.getHeaders(RequireHeader.NAME);
    	if (requireIterator != null) {
    		while (requireIterator.hasNext()) {
    			RequireHeader requireHeader = (RequireHeader) requireIterator
    					.next();
    			String requireTag = requireHeader.getOptionTag();
    			if (requireTag.equalsIgnoreCase(optionTag))
    				return true;
    		}
    	}
    	return false;
    ...
    /**
     * judge if the message support the optionTag
     * @param message
     * @param optionTag
     * @return  boolean: true :support the optionTag false:not support
     */
    private static boolean isSupportedOptionTagExist(Message message,
    		String optionTag) {
    	ListIterator supportedIterator = message
    			.getHeaders(SupportedHeader.NAME);
    	if (supportedIterator != null) {
    		while (supportedIterator.hasNext()) {
    			SupportedHeader supportedHeader = (SupportedHeader) supportedIterator
    					.next();
    			String supportedTag = supportedHeader.getOptionTag();
    			if (supportedTag.equalsIgnoreCase(optionTag))
    				return true;
    		}
    	}
    	return false;
     ...
     * 
     */
    public boolean sendPrack(String body, String contentType,
            String contentSubType, ArrayList additionalHeaders,
            ArrayList replaceHeaders)
    {
        try
        {
            return sendPrack(parent.toHeader(additionalHeaders,
    ...
    /**
     * This method sends a basic UPDATE request.
     * 
     * @return true if the message was successfully sent, false otherwise.
     */
    public boolean sendUpdate()
    {
        return sendUpdate(null, null, null);
    }

    /**
     * This method is the same as the basic sendUpdate() method except that
     * it allows the caller to specify a message body and/or additional JAIN-SIP
     * API message headers to add to or replace in the outbound message. Use of
     * this method requires knowledge of the JAIN-SIP API.
     * 
     ...
     *            body bytes.
     */
    public boolean sendUpdate(ArrayList additionalHeaders,
            ArrayList replaceHeaders, String body)
    {
        return sendRequest(Request.UPDATE, additionalHeaders, replaceHeaders, body);
    }
     ...
     * 
     */
    public boolean sendUpdate(String body, String contentType,
            String contentSubType, ArrayList additionalHeaders,
            ArrayList replaceHeaders)
    {
        try
        {
            return sendUpdate(parent.toHeader(additionalHeaders,
                    contentType, contentSubType), parent
                    .toHeader(replaceHeaders), body);
        }
        catch (Exception ex)
    ...
    /**
     * This method sends a specific method request.
     * 
     * @param method
    ...
    {
        return sendRequest(method, null, null, null);
    }

    /**
     * This method is the same as the basic sendRequest() method except that
     * it allows the caller to specify a message body and/or additional JAIN-SIP
     * API message headers to add to or replace in the outbound message. Use of
     * this method requires knowledge of the JAIN-SIP API.
     * 
     ...
     *            body bytes.
     */
    public boolean sendRequest(String method, ArrayList additionalHeaders,
            ArrayList replaceHeaders, String body)
    {
        initErrorInfo();
        ...
        try
        {
            ...
            parent.addAuthorizations(callId.getCallId(), request);

            synchronized (this) // needed for asynchronous response -
            {
                parent.sendRequestWithTransaction(request, false,
                        dialog, this, additionalHeaders, replaceHeaders, body);
            }
     ...
     * 
     */
    public boolean sendRequest(String method, String body, String contentType,
            String contentSubType, ArrayList additionalHeaders,
            ArrayList replaceHeaders)
    {
        try
        {
            return sendRequest(method, parent.toHeader(additionalHeaders,
                    contentType, contentSubType), parent
                    .toHeader(replaceHeaders), body);
        }
        catch (Exception ex)
    ...
    /**
     * This method sends a basic CANCEL request.
     * 
     * @return true if the message was successfully sent, false otherwise.
     */
    ...
    /**
     * This method is the same as the basic sendCancel() method except that
     * it allows the caller to specify a message body and/or additional JAIN-SIP
     * API message headers to add to or replace in the outbound message. Use of
     * this method requires knowledge of the JAIN-SIP API.
     * 
     ...
     *            body bytes.
     */
    public boolean sendCancel(ArrayList additionalHeaders,
            ArrayList replaceHeaders, String body)
    {
        initErrorInfo();
        ...
        try
        {
        	...
        	Request cancel = ((ClientTransaction) dialog.getFirstTransaction()).createCancel();
            parent.addAuthorizations(callId.getCallId(), cancel);
            synchronized (this) // needed for asynchronous response -
            {
                parent.sendRequestWithTransaction(cancel, false,
                        dialog, this, additionalHeaders, replaceHeaders, body);
            }
     ...
     * 
     */
    public boolean sendCancel(String body, String contentType,
            String contentSubType, ArrayList additionalHeaders,
            ArrayList replaceHeaders)
    {
        try
        {
            return sendCancel(parent.toHeader(additionalHeaders,
                    contentType, contentSubType), parent
                    .toHeader(replaceHeaders), body);
        }
        catch (Exception ex)

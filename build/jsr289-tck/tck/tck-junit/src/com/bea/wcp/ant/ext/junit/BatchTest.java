...
public final class BatchTest extends BaseTest {
    ...
    private JUnitTest createJUnitTest(String classname) {
        JUnitTest test = new TckJUnitTest();
...
//        	System.out.println("===============" + ((FormatterElement)tmp).getClassname());
//        	System.out.println("===============" + ((FormatterElement)tmp).getExtension());
        	TckFormatterElement tck = 
        		(TckFormatterElement) convertFormatter((FormatterElement)tmp);
            test.addFormatter(tck);
//        	System.out.println("=============== after convertion:" + tck.getClass().getName());
//        	System.out.println("===============after convertion:" + tck.getClassname());
//        	System.out.println("===============after convertion:" + tck.getExtension());
        }
        return test;
    }
    
    static TckFormatterElement convertFormatter(FormatterElement e){
    	if(e instanceof TckFormatterElement){
    		return (TckFormatterElement) e;
    	}
    	TckFormatterElement newOne = new TckFormatterElement(e);
    	return newOne;
    }

...
public class TckJUnitTestRunner implements TestListener {
     ...
     * classpath.
     */
    public TckJUnitTestRunner(JUnitTest test, boolean haltOnError,
    ...
    public void run() {    	
        ...
        try {
            ...
            Test suiteProxy = TestProxy.getInstance(suite);
            fireStartTestSuite();
    ...
    private static void transferFormatters(TckJUnitTestRunner runner,
                                           JUnitTest test) {
        for (int i = 0; i < fromCmdLine.size(); i++) {
            TckFormatterElement fe = (TckFormatterElement) fromCmdLine.elementAt(i);
    ...
    private static void createAndStoreFormatter(String line)
        ...
        TckFormatterElement fe = new TckFormatterElement();
    ...
    public static String getFilteredTrace(Throwable t) {
        ...
        return TckJUnitTestRunner.filterStack(trace);
    }
    ...
    private static int launch(JUnitTest t, boolean haltError,
        ...
        TckJUnitTestRunner runner =
            new TckJUnitTestRunner(t, haltError, stackfilter, haltFail, showOut);
        runner.forked = true;

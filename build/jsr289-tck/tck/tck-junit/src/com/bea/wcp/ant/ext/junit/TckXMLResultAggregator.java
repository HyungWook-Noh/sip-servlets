...
/**
 * This class is almost same with original XMLResultAggregator class provided 
 * by Apache. The most important different is the AggregateTransformer used by this class is 
 * TckAggregateTransformer.
 ...
 */
public class TckXMLResultAggregator extends Task implements XMLConstants {
     ...
     * @return the report
     */
    public TckAggregateTransformer createReport() {
        TckAggregateTransformer transformer = new TckAggregateTransformer(this);
    ...
    public void execute() throws BuildException {
        ...
        while (e.hasMoreElements()) {
            TckAggregateTransformer transformer =
                (TckAggregateTransformer) e.nextElement();

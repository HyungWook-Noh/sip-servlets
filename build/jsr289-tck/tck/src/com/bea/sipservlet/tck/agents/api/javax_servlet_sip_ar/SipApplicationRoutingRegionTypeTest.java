 ...
 *  All rights reserved.
 *
 * SipApplicationRoutingRegionTypeTest is used to test the APIs of
...
public class SipApplicationRoutingRegionTypeTest extends TestBase {
  public SipApplicationRoutingRegionTypeTest(String arg0) throws IOException {
    super(arg0);
  }

  @AssertionIds(
      ids = "SipServlet:JAVADOC:SipApplicationRoutingRegionType1"
      )

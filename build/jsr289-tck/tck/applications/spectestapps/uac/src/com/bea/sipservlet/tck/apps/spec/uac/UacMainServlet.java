 ...
 * All Rights Reserved.
 * 
 * This class is the main servlet in the JSR 289 Spec test
...
@javax.servlet.sip.annotation.SipServlet(name = "UacMainServlet")
public class UacMainServlet extends BaseServlet {
  private static final long serialVersionUID = -8834813875572692727L;
  private static final Logger logger = Logger.getLogger(UacMainServlet.class);

...
@javax.servlet.sip.annotation.SipServlet(name = "B2buaMainServlet")
public class B2buaMainServlet extends BaseServlet {
  private static final long serialVersionUID = -8834813875572692727L;
  private static final Logger logger = Logger.getLogger(B2buaMainServlet.class);

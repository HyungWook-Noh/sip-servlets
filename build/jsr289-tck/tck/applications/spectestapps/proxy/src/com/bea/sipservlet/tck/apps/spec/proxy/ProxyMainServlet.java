...
@javax.servlet.sip.annotation.SipServlet(name = "ProxyMainServlet")
public class ProxyMainServlet extends BaseServlet {
  private static final long serialVersionUID = -8834813875572692727L;
  private static Logger logger = Logger.getLogger(ProxyMainServlet.class);

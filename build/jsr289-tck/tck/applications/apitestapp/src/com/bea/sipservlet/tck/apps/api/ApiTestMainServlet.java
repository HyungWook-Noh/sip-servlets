...
@javax.servlet.sip.annotation.SipServlet(name = "ApiTestMainServlet")
public class ApiTestMainServlet extends BaseServlet {
  private static final long serialVersionUID = -8834813875572692727L;
  private static Logger logger = Logger.getLogger(ApiTestMainServlet.class);
  ...
  public void doRequest(SipServletRequest req)
    ...
    if(req.isInitial()) {
    	req.removeHeader(TestConstants.APP_HEADER);
      ...
      logger.error("=== unexpected subsequent request is received by main servlet:"
  ...
  public void doResponse(SipServletResponse resp)
    ...
    logger.error("=== main servlet received response:" + resp.getMethod() + "/"
        + resp.getStatus() + " ===");
